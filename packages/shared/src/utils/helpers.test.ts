...
import { Card, Player, AvatarType, ConnectionStatus, VictoryCondition } from '../types/core.js';
...
describe('Helpers', () => {
  ...
  describe('isValidTrio', () => {
    it('should validate correct trios', () => {
      const cards: Card[] = [
        { id: '1', number: 5, isRevealed: true, location: 'TRIO_PILE' as any },
        { id: '2', number: 5, isRevealed: true, location: 'TRIO_PILE' as any },
        { id: '3', number: 5, isRevealed: true, location: 'TRIO_PILE' as any },
      ];
    ...
    it('should reject invalid trios', () => {
      const cards: Card[] = [
        { id: '1', number: 5, isRevealed: true, location: 'TRIO_PILE' as any },
        { id: '2', number: 6, isRevealed: true, location: 'TRIO_PILE' as any },
        { id: '3', number: 5, isRevealed: true, location: 'TRIO_PILE' as any },
      ];
  ...
  describe('checkVictoryConditions', () => {
    const createPlayer = (trios: number[]): Player => ({
      id: generateUUID(),
      name: 'Test Player',
