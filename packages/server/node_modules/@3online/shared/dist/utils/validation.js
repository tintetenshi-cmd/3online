 ...
 */
import { CardLocation, ActionType, GameStatus, } from '../types/core.js';
...
export function validateTrio(trio) {
    const errors = [];
...
export function validateGameAction(action) {
    const errors = [];
...
export function validateRoomInfo(roomInfo) {
    const errors = [];
...
export function validateCardIntegrity(gameState) {
    const errors = [];
